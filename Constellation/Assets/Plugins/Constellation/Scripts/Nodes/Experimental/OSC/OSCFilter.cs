...
namespace Constellation.Experimental {
    public class OSCFilter : INode, IReceiver{
        private ISender sender;
        private Attribute ChannelName; // attributes are setted in the editor.
         public const string NAME = "OSCFilter"; //Setting the node name (need to be a const to be used in the factory without the node instantiated)
        ...
        public void Setup (INodeParameters _node, ILogger _logger) {
            ...
            ChannelName = _node.AddAttribute (wordValue.Set("Var"), Attribute.AttributeType.Word, "/Channel");// setting an attribute (Used only for the editor)
        }
