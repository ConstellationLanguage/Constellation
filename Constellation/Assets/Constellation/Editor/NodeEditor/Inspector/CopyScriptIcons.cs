...
public class CopyScriptIcons : Editor {
    ...
    static CopyScriptIcons () {
        var source = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Gizmos/ConstellationScript.png", typeof(Texture2D));
        var target = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Gizmos/ConstellationScript Icon.png", typeof(Texture2D));
        if(source != null && target == null) 
            AssetDatabase.CopyAsset("Assets/Gizmos/ConstellationScript.png", "Assets/Gizmos/ConstellationScript Icon.png");
    }
}