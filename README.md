...
# What is it?
Constellation is a node based programming language for unity that gives you the tools of a programmer without having to write a single line of code. It's currently in alpha wich mean there is a lot of incomplete features/bugs. If you find one feal free to report it [here](https://www.constellationeditor.com/forum-1/suggestions)
