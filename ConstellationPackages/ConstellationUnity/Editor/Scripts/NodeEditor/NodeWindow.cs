...
namespace ConstellationUnityEditor
{
    public class NodeWindow
    {
        ...
        public NodeWindow(ConstellationEditorDataService _constellationEditorData, Vector2 windowSize, Vector2 scrollPosition)
        {
            ...
            var backgroundTexture = AssetDatabase.LoadAssetAtPath(ConstellationEditor.GetEditorAssetsPath() + "/background.png", typeof(Texture2D)) as Texture2D;
        ...
        {
            constellationRules.UpdateGenericNodeByLinkGUID(ConstellationScript.script, NodeFactory, guid, new UnityConstellationParser());
        }
