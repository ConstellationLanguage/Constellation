    ...
    public class ConstellationEditorDataService
    {
        ...
        public ConstellationEditorStyles GetConstellationEditorConfig()
        {
            if (ConstellationEditorStyles == null)
                ConstellationEditorStyles = (ConstellationEditorStyles)AssetDatabase.LoadAssetAtPath(ConstellationEditor.GetEditorConfigPath() + "/ConstellationStyle.Asset", typeof(ConstellationEditorStyles));
        ...
        {
            var path = ConstellationEditor.GetEditorDataFolderPath() + "/EditorData.asset";
            var assemblyPath = ConstellationEditor.GetEditorDataFolderPath() + "/ConstellationAssembly.asset";
