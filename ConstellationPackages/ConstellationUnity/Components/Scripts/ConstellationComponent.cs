...
namespace Constellation.Unity3D
{
    public class ConstellationComponent : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            constellation = new Constellation(ConstellationData.script, nodeFactory, new UnityConstellationParser(), (newNode, node) =>
                {
            ...
            if (constellation.GetInjector() is IAwakable)
                (constellation.GetInjector() as IAwakable).OnAwake();
            isInitialized = true;
        }
