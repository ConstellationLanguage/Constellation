    ...
    public class ConstellationBehaviour : ConstellationEditable
    {
        ...
        void OnDestroy()
        {
            if (constellation.GetInjector() is IDestroy)
                (constellation.GetInjector() as IDestroy).OnDestroy();
        }
        ...
        void Update()
        {
            ...
            if (constellation.GetInjector() is IUpdatable)
                (constellation.GetInjector() as IUpdatable).OnUpdate();
        }

        void FixedUpdate()
        {
            if (constellation.GetInjector() is IFixedUpdate)
                (constellation.GetInjector() as IFixedUpdate).OnFixedUpdate();
        }
        ...
        void LateUpdate()
        {
            ...
            if (constellation.GetInjector() is ILateUpdatable)
                (constellation.GetInjector() as ILateUpdatable).OnLateUpdate();
        }
        ...
        void OnCollisionEnter(Collision collision)
        {
            if (constellation.GetInjector() is ICollisionEnter)
                (constellation.GetInjector() as ICollisionEnter).OnCollisionEnter(collision);
        }

        void OnCollisionStay(Collision collision)
        {
            if (constellation.GetInjector() is ICollisionStay)
                (constellation.GetInjector() as ICollisionStay).OnCollisionStay(collision);
        }
        void OnCollisionExit(Collision collision)
        {
            if (constellation.GetInjector() is ICollisionExit)
                (constellation.GetInjector() as ICollisionExit).OnCollisionExit(collision);
        }
    }
}